 ...
 * Simplified version - used within StatsHeader layout.
 */
...
export function PracticeButton({ courseId }: PracticeButtonProps) {
    return (
        ...
        >
            <div className="relative h-full overflow-hidden rounded-xl bg-gradient-to-r from-primary to-primary/80 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-primary/25 hover:scale-[1.02]">
                {/* Background pattern */}
