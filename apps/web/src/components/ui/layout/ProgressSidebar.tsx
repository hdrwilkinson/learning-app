 ...
 * ProgressSidebar
 *
 * Sidebar for enrolled users showing leaderboards, daily quests, and progress stats.
 */
...
import { ProgressStats, type CourseProgress } from "./ProgressStats";
...
export function ProgressSidebar({
    ...
    // courseId will be used for leaderboard/quest links when implemented
    void _courseId;
