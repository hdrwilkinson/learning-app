...
│         │                                                       │
│         ▼                                                       │
│  Opens course creation chat with system prompt:                 │
...
```
┌─────────────────────────────────────────────────────────────────┐
│  User in Curiosity Mode, exploring "machine learning"           │
│         │                                                       │
│         ▼                                                       │
│  [Create Course from This Topic]                                │
│         │                                                       │
│         ▼                                                       │
│  Course creation chat opens with conversation context           │
│  AI: "I see you're interested in machine learning.              │
│       Let's build a course! What's your goal?"                  │
└─────────────────────────────────────────────────────────────────┘
```
...
| --- | ------------------ | --------------- | -------- |
| 1   | **Topic**          | Conversation    | ✅ Yes   |
| 2   | **Learning Goals** | Conversation    | ✅ Yes   |
| 3   | **Current Level**  | Baseline Quiz   | ✅ Yes   |
| 4   | **Study Days**     | React Component | ✅ Yes   |
| 5   | **Time per Day**   | React Component | ✅ Yes   |
...
│                                                                 │
│  User: "I want to analyze sales data at my job"                 │
│                                                                 │
...
```
┌─────────────────────────────────────────────────────────────────┐
│  AI: "Before I build your course, let me see what you          │
│       already know. This helps me skip stuff you've mastered." │
│                                                                 │
│  [Start Quiz]  [Skip - I'm a complete beginner]                 │
│                        │                                        │
│                        └─→ Sets level to 1, skips quiz          │
└─────────────────────────────────────────────────────────────────┘
```
...
```
┌─────────────────────────────────────────────────────────────────┐
│  BASELINE QUIZ                                    Strikes: ✓✓✗  │
│  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  │
│                                                                 │
│  Q4 (Level 5): What's the output of `"hello"[1:4]`?             │
│                                                                 │
│  ○ "hel"                                                        │
│  ○ "ell"                                                        │
│  ○ "ello"                                                       │
...
```
┌─────────────────────────────────────────────────────────────────┐
│  ❌ Strike 3 on Question 7 (Level 6)                             │
│                                                                 │
│  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  │
│                                                                 │
│  AI: "Got it! You've got solid Python fundamentals.             │
│       I'll build your course starting from intermediate         │
│       concepts like data manipulation."                         │
│                                                                 │
│  Your assessed level: 5/10                                      │
│                                                                 │
...
│  │  └─────┘ └─────┘ └─────┘ └─────┘ └─────┘ └─────┘ └─────┘│    │
│  │                                                         │    │
│  │  Quick select: [Weekdays] [Every day] [Weekends]        │    │
│  │                                                         │    │
│  └─────────────────────────────────────────────────────────┘    │
│                                                                 │
│  [Continue]                                                     │
...
```
┌─────────────────────────────────────────────────────────────────┐
│  AI: "How long will you study each session?"                    │
│                                                                 │
│  ┌─────────────────────────────────────────────────────────┐    │
│  │                                                         │    │
│  │  5 min ├────────────●────────────────────────┤ 2 hours  │    │
...
│  │                30 minutes                               │    │
│  │                                                         │    │
│  │  Presets: [15m] [30m] [45m] [1hr] [1.5hr] [2hr]         │    │
│  │                                                         │    │
│  └─────────────────────────────────────────────────────────┘    │
│                                                                 │
│  [Continue]                                                     │
...
│       🎯 Goal: Analyze sales data at work                       │
│       📊 Your level: 5/10 (intermediate)                        │
│       📅 Schedule: Weekdays, 30 min/day                         │
│                                                                 │
│       I'll create a personalized course for you now.            │
│       This takes a few minutes - I'll notify you when ready!"   │
│                                                                 │
│  ┌─────────────────────────────────────────────────────────┐    │
...
```
┌─────────────────────────────────────────────────────────────────┐
│  COURSE GENERATION PIPELINE (Background)                        │
├─────────────────────────────────────────────────────────────────┤
│                                                                 │
│  Input: Topic, Goals, Level, Schedule                           │
│                                                                 │
...
│                                                                 │
│  Output: Complete course saved to database                      │
...
Each stage follows a create → validate → adjust loop:
...
5. Allocate IPs across modules (total ≤ {targetIPs})
...
async function finalizeAndNotify(course: Course, user: User): Promise<void> {
    ...
    await sendEmail(user.email, {
      ...
      ⏱️ Estimated ${estimates.weeks} weeks at your pace
...
| 3 days × 60 min | 180          | ~125       | 8-10 weeks    |
