...
const ALGORITHM_CONFIG = {
    // Mastery
    MASTERY_THRESHOLD: 0.8, // Level to reach 'mastered' state
    ...
    // Skip Quiz
    SKIP_QUIZ_PASS_THRESHOLD: 0.8,
    SKIP_MASTERY_INITIAL: 0.6,
    SKIP_BASELINE_INITIAL: 0.5,
    SKIP_CONFIDENCE_INITIAL: 0.3,
